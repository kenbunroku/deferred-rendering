...
export class WebGLOrbitCamera {
  ...
  constructor(target, option = {}) {
    ...
    this.qtx = Qtn.create();
    this.qty = Qtn.create();
    this.fov = option.fov || 45 * (Math.PI / 180); // Convert degrees to radians
    this.aspect = option.aspect || target.clientWidth / target.clientHeight;
    this.near = option.near || 0.1;
    this.far = option.far || 1000.0;
